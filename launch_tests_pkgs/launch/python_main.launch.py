...
def generate_launch_description():
    ...
    #  FindPackageShare is officially recommended by the ROS API.
    # Note that you always need to pass a list version of the dictionary. 
    # That is why you use the items() method.
    ...
    ros2 launch launch_tests_pkg python_main.launch.py turning_speed:=6.0 forward_speed:=0.2
    '''
