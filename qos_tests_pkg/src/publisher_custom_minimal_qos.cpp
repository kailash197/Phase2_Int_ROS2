...
In the publisher, the event of incompatible_qos is TRIGGERED, showing you the
message inside the Callback incompatible_qos_clb.

In the subscriber, you get the warning of Incompatible QoS.

The reason is that the QoS of the publisher and subscriber are INCOMPATIBLE:

Publisher QoS Reliability=Best_Effort
Subscriber QoS Reliability=Reliable
It also states the QoS that is incompatible, at least the last one:
